...
class SkipGramNeg(nn.Module):
    ...
    Attributes:
    - n_vocab (int): integer count of the vocabulary size.
    - n_embed (int): integer specifying the dimensionality of the embeddings.
    ...
    def __init__(self, n_vocab: int, n_embed: int, noise_dist: torch.Tensor = None):
        ...
        - n_embed (int): size of each embedding vector.
